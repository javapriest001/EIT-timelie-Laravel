    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('deskofficerupdateprofile')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input class="form-control" id="password" name="password" placeholder="Enter Password" type="number">
